...
func AutomigrateConceptoTablasPublicas(db *gorm.DB) error {
	...
	if err == nil {
		...
		db.Exec("INSERT INTO TIPOIMPUESTOGANANCIA(created_at, nombre, codigo, descripcion, activo, aplicaimporteremunerativo, aplicaimportenoremunerativo,aplicadescuento, aplicaretencion,aplicaaportepatronal) VALUES (current_timestamp,'Remuneración bruta','REMUNERACION_BRUTA','',1, true, true, true, false, false)")
		db.Exec("INSERT INTO TIPOIMPUESTOGANANCIA(created_at, nombre, codigo, descripcion, activo, aplicaimporteremunerativo, aplicaimportenoremunerativo,aplicadescuento, aplicaretencion,aplicaaportepatronal) VALUES(current_timestamp,'Retribuciones no habituales','RETRIBUCIONES_NO_HABITUALES','',1, true, true, true, false, false)")
		...
		db.Exec("INSERT INTO TIPOIMPUESTOGANANCIA(created_at, nombre, codigo, descripcion, activo, aplicaimporteremunerativo, aplicaimportenoremunerativo,aplicadescuento, aplicaretencion,aplicaaportepatronal) VALUES(current_timestamp,'Aportes obra social','APORTES_OBRA_SOCIAL','',1, false, false, false, true, false)")
		db.Exec("INSERT INTO TIPOIMPUESTOGANANCIA(created_at, nombre, codigo, descripcion, activo, aplicaimporteremunerativo, aplicaimportenoremunerativo,aplicadescuento, aplicaretencion,aplicaaportepatronal) VALUES(current_timestamp,'Cuota sindical','CUOTA_SINDICAL','',1, false, false, false, true, false)")
		...
		db.Exec("INSERT INTO TIPOIMPUESTOGANANCIA(created_at, nombre, codigo, descripcion, activo, aplicaimporteremunerativo, aplicaimportenoremunerativo,aplicadescuento, aplicaretencion,aplicaaportepatronal) VALUES(current_timestamp,'Otras deducciones','OTRAS_DEDUCCIONES','',1, false, false, false, true, false)")
