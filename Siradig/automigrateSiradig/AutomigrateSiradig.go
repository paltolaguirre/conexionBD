...
func AutomigrateSiradigTablasPublicas(db *gorm.DB) error {
	...
	if err == nil {
		...
		db.Exec("INSERT INTO SIRADIGTIPOGRILLA(created_at, nombre, codigo, descripcion, activo) VALUES (current_timestamp,'Sr. JUBILADO/PENSIONADO Y/O RETIRADO: ¿Tributó Bienes Personales en el último período fiscal anterior al que está declarando?','SR_JUBILADO_PENSIONADO_RETIRADO_TRIBUTO_BIENES_PERSONALES_EN_EL_ULTIMO_PERIODO_FISCAL_ANTERIOR_AL_DECLARADO','',1)")
