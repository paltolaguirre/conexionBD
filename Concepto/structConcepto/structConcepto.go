...
type Concepto struct {
	...
	Tipoimpuestoganancia   *Tipoimpuestoganancia `json:"tipoimpuestoganancia" gorm:"ForeignKey:Tipoimpuestogananciaid;association_foreignkey:ID;association_autoupdate:false;not null"`
	Tipoimpuestogananciaid *int                  `json:"tipoimpuestogananciaid"`
}
