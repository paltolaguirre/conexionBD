...
type Liquidacion struct {
	...
	Zonaid                               *int                      `json:"zonaid" gorm:"ForeignKey:zonaid;association_foreignkey:ID;association_autoupdate:false"`
	Zona                                 *Zona                     `json:"zona" sql:"type:int REFERENCES Zona(ID)"`
}
